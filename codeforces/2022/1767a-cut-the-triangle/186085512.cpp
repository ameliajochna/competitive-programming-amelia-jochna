...
void solve() {
  ...
  if ((a.st == b.st || a.st == c.st || b.st == c.st) &&
      (a.nd == b.nd || a.nd == c.nd || b.nd == c.nd)) {
    cout << "NO\n";
  } else
    cout << "YES\n";
}
...
/*
   g++ -std=c++11 -DLOCAL -Wall -Wextra -Wconversion -Wshadow
   -Wno-sign-conversion -D_GLIBCXX_DEBUG -fno-sanitize-recover=undefined
   -fsanitize=undefined -DPRAYFORSOLVE -fsanitize=address
